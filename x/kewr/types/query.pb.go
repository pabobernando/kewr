...
func (*QueryParamsRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_290e1fae70aa1419, []int{0}
}
...
func (*QueryParamsResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_290e1fae70aa1419, []int{1}
}
...
func init() {
	proto.RegisterType((*QueryParamsRequest)(nil), "kewr.kewr.QueryParamsRequest")
	proto.RegisterType((*QueryParamsResponse)(nil), "kewr.kewr.QueryParamsResponse")
}

func init() { proto.RegisterFile("kewr/kewr/query.proto", fileDescriptor_290e1fae70aa1419) }

var fileDescriptor_290e1fae70aa1419 = []byte{
	// 289 bytes of a gzipped FileDescriptorProto
	0x1f, 0x8b, 0x08, 0x00, 0x00, 0x00, 0x00, 0x00, 0x02, 0xff, 0xe2, 0x12, 0xcd, 0x4e, 0x2d, 0x2f,
	...
	0x1c, 0x06, 0xc6, 0x80, 0x00, 0x00, 0x00, 0xff, 0xff, 0x55, 0x3d, 0x82, 0xbe, 0xb2, 0x01, 0x00,
	0x00,
}
...
func (c *queryClient) Params(ctx context.Context, in *QueryParamsRequest, opts ...grpc.CallOption) (*QueryParamsResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/kewr.kewr.Query/Params", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _Query_Params_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/kewr.kewr.Query/Params",
	}
...
var _Query_serviceDesc = grpc.ServiceDesc{
	...
	Metadata: "kewr/kewr/query.proto",
}
